...
from utils.utils_fit_enhance import fit_one_epoch
...
if __name__ == "__main__":
    ...
    if local_rank == 0:
        show_config(
            classes_path = classes_path, anchors_path = anchors_path, anchors_mask = anchors_mask,  input_shape = input_shape, \
