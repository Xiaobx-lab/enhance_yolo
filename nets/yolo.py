...
class Enhance_yolo(nn.Module):
    def __init__(self, ):
        super(Enhance_yolo, self).__init__()
        self.AFS8 = AFS(256,256,in_channel2=512,out_channel2=512)
        self.AFS16 = AFS(512,512,in_channel2=1024,out_channel2=1024)
        self.anchors_mask = [[6, 7, 8], [3, 4, 5], [0, 1, 2]]
        self.yolo = YoloBody(3,3,anchors_mask=[[6, 7, 8], [3, 4, 5], [0, 1, 2]], num_classes=20, bilinear=False)
        self.device = 0        
       # for k, v in self.yolo.named_modules():
      ...
      #          continue        
        ...
        #print('have done successfully')



    def forward(self, x):
        enhance_out, out0, out1, out2 = self.yolo(x,self.AFS8, self.AFS16)
        return enhance_out, out0, out1, out2
